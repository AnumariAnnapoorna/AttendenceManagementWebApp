<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="java.sql.*,java.util.Date,java.text.SimpleDateFormat,java.text.DecimalFormat,java.io.* "%>
...
try {
	String namefile=branch+"_"+facultyid+"_"+branch+"_"+year+"_"+section+"_Release"+datestring1;
